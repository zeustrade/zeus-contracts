...
contract VaultUtils is IVaultUtils {
    ...
    function addPosition(bytes32 pos, address _account, address _collateralToken, address _indexToken, bool _isLong)
        public
        override
    {
    ...
    function getPositionsPaginated(uint256 cursor, uint256 howMany)
        public
        view
        returns (bytes32[] memory, uint256 newCursor)
    {
