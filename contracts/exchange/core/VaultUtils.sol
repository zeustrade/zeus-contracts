...
contract VaultUtils is IVaultUtils, Governable {
    ...
    function addPosition(bytes32 pos, address _account, address _collateralToken, address _indexToken, bool _isLong) public override {
    ...
    function getPositionKeyByIndex(uint256 index) public view returns(bytes32) {
        return bytes32(positions.at(index));
    }

    function getPositionsAmount() public view returns(uint256) {
        return positions.length();
    }

    function getPositionsPaginated(uint256 cursor, uint256 howMany) public view returns(bytes32[] memory, uint256 newCursor) {
        ...
        for (uint256 i = 0; i < length; i++) {
            values[i] = bytes32(positions.at(cursor + i));
        }
    ...
    function validateIncreasePosition(address /* _account */, address /* _collateralToken */, address /* _indexToken */, uint256 /* _sizeDelta */, bool /* _isLong */) external view override {
        // no additional validations
    }

    function validateDecreasePosition(address /* _account */, address /* _collateralToken */, address /* _indexToken */ , uint256 /* _collateralDelta */, uint256 /* _sizeDelta */, bool /* _isLong */, address /* _receiver */) external view override {
        // no additional validations
    }
    ...
    function getPositionFee(address /* _account */, address /* _collateralToken */, address /* _indexToken */, bool /* _isLong */, uint256 _sizeDelta) public view override returns (uint256) {
    ...
    function getFundingFee(address /* _account */, address _collateralToken, address /* _indexToken */, bool /* _isLong */, uint256 _size, uint256 _entryFundingRate) public view override returns (uint256) {
        if (_size == 0) { return 0; }
    ...
    function getSwapFeeBasisPoints(address _tokenIn, address _tokenOut, uint256 _usdgAmount) public view override returns (uint256) {
    ...
    function getFeeBasisPoints(address _token, uint256 _usdgDelta, uint256 _feeBasisPoints, uint256 _taxBasisPoints, bool _increment) public view override returns (uint256) {
